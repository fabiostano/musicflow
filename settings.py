...
SESSION_CONFIGS = [dict(name='full_research_first', num_demo_participants=2, app_sequence=['Intro', 'EEG_Setup', 'Research', 'Matching', 'Outro']),
                   dict(name='full_matching_first', num_demo_participants=2, app_sequence=['Intro', 'EEG_Setup', 'Matching', 'Research', 'Outro']),
                   ...
                   dict(name='pre_mail_first', num_demo_participants=None, app_sequence=['Intro', 'N_back', 'Matching', 'Outro']),
                   dict(name='pre_data_first', num_demo_participants=None, app_sequence=['Intro', 'Matching', 'N_back', 'Outro'])]
LANGUAGE_CODE = 'en'
